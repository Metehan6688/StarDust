...
## [4.4] - 2026-07-27 -broadcast update
...
## [3.0] - 2026-02-1 -monolithic update
...
## [2.0] (never released) -no update
- Some bug fixes but actually this isn't a real version.

## [1.0] - 2025-12-31 basic protect update
- This version I added basic XOR checksum

## [0.x] / Alpha / Base - pre versions updates
